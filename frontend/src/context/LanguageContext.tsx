...
const en: Translations = {
  ...
  shopLinks: ["All Products", "T-Shirts", "Hoodies", "Pants", "New Arrivals"],
  ...
  product: { addToCart: "ADD TO CART", sizeGuide: "Size Guide", inStock: "In Stock", reviews: "Reviews", youMayLike: "YOU MAY ALSO LIKE", viewAll: "View all", freeShipping: "Shipping calculated at checkout", returns: "14-Day Returns", secure: "Secure Checkout" },
  ...
  home: {
    ...
    featFreeShipping: "Shipping Across Egypt", featFreeShippingDesc: "Shipping is calculated at checkout",
    featEasyReturns: "Easy Returns", featEasyReturnsDesc: "14-day return policy",
    ...
    fastDelivery: "Fast Delivery", fastDeliveryDesc: "Get it within 3-5 days.",
  ...
  productDetail: {
    ...
    freeShipping: "Shipping calculated at checkout", returns: "14-Day Returns", secure: "Secure Checkout",
...
const ar: Translations = {
  ...
  shopLinks: ["جميع المنتجات", "تيشيرتات", "هوديز", "بناطيل", "وصل حديثاً"],
  ...
  product: { addToCart: "أضف للسلة", sizeGuide: "دليل المقاسات", inStock: "متوفر", reviews: "تقييمات", youMayLike: "قد يعجبك أيضاً", viewAll: "عرض الكل", freeShipping: "الشحن يُحسب عند إتمام الطلب", returns: "إرجاع خلال 14 يوم", secure: "دفع آمن" },
  ...
  home: {
    ...
    featFreeShipping: "شحن لجميع أنحاء مصر", featFreeShippingDesc: "قيمة الشحن تظهر عند إتمام الطلب",
    featEasyReturns: "إرجاع سهل", featEasyReturnsDesc: "سياسة إرجاع 14 يوم",
    ...
    fastDelivery: "توصيل سريع", fastDeliveryDesc: "وصول خلال 3-5 أيام.",
  ...
  productDetail: {
    ...
    freeShipping: "الشحن يُحسب عند إتمام الطلب", returns: "إرجاع خلال 14 يوم", secure: "دفع آمن",
