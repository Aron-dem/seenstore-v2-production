...
const en: Translations = {
  ...
  product: { addToCart: "ADD TO CART", sizeGuide: "Size Guide", inStock: "In Stock", reviews: "Reviews", youMayLike: "YOU MAY ALSO LIKE", viewAll: "View all", freeShipping: "Free Shipping over 500 EGP", returns: "14-Day Returns", secure: "Secure Checkout" },
  ...
  productDetail: {
    ...
    freeShipping: "Free Shipping over 500 EGP", returns: "14-Day Returns", secure: "Secure Checkout",
...
const ar: Translations = {
  ...
  product: { addToCart: "أضف للسلة", sizeGuide: "دليل المقاسات", inStock: "متوفر", reviews: "تقييمات", youMayLike: "قد يعجبك أيضاً", viewAll: "عرض الكل", freeShipping: "شحن مجاني فوق 500 جنيه", returns: "إرجاع خلال 14 يوم", secure: "دفع آمن" },
  ...
  productDetail: {
    ...
    freeShipping: "شحن مجاني فوق 500 جنيه", returns: "إرجاع خلال 14 يوم", secure: "دفع آمن",
