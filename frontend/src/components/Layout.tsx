        ...
        <div className="container mx-auto px-6 md:px-12 max-w-[1400px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
            ...
            <div className="md:col-span-2 lg:col-span-1">
              ...
              <form 
                onSubmit={(e) => { e.preventDefault(); toast.success(isRTL ? "تم الاشتراك بنجاح!" : "Subscribed successfully!"); }}
              ...
              >
                ...
                <button 
                  type="submit"
                  className="bg-black text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-[#E63946] transition-colors"
                >
                  {isRTL ? "اشترك" : "Join"}
                </button>
              </form>
